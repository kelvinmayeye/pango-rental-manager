...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{ asset('backend/dist/img/user2-160x160.png') }}" class="img-circle elevation-2"
                     alt="User Image">
            </div>
            <div class="info">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link">
                        ...
                        <p>
                            Messages
                            <i class="right fas fa-angle-left"></i><!-- Todo:implement messages -->
                        </p>
                    </a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link">
                        ...
                        <p>Settings</p><!-- Todo: implement settings -->
                    </a>
                </li>
            </ul>
        </nav>
