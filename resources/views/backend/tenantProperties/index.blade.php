                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if ($tenantProperty->is_active == 1)
                                                <a href="{{ route('tenantProperties.status', $tenantProperty->id) }}"
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <div>
                                                    <a href="" type="button" class="btn btn-sm btn-success mx-2"
                                                       data-toggle="modal"
                                                ...
                                                <form
                                                    action="{{ route('tenantProperties.destroy',$tenantProperty->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
